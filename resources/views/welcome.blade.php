    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
          ...
          <div class="flex justify-center">
            <img src="{{ asset('images/bizmalogo.png') }}" alt="Logo" style="width: 100px; height: auto; margin: 0 auto; display: block;">
             </div>
                ...
                @else
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="block mt-4">
                            <label for="remember_me" class="inline-flex absolute items-center">
                        ...
                        <div class="mt-8 flex items-center justify-center ">
                            <button type="submit" class="ml-3 inline-flex items-center px-[160px] py-3 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Log in
                            </button>
                        </div>
